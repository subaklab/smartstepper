package io.subak.bleexample;

import io.subak.bleexample.BleDefinedUUIDs.LbsStrings;
...
public class BleNamesResolver {
    ...
    static {
        ...
        mServices.put("f000aa10-0451-4000-b000-000000000000", "SensorTag Accelerometer Service");
        mServices.put("f000aa20-0451-4000-b000-000000000000", "SensorTag Humidity Service");
        mServices.put("f000aa30-0451-4000-b000-000000000000", "SensorTag Magnetometer Service");
        mServices.put("f000aa40-0451-4000-b000-000000000000", "SensorTag Barometer Service");
        mServices.put("f000aa50-0451-4000-b000-000000000000", "SensorTag Gyroscope Service");
        mServices.put("0000ffe0-0000-1000-8000-00805f9b34fb", "SensorTag Keys Service");

        // TI SensorTag Proprietary Characteristics
        mCharacteristics.put("f000aa00-0451-4000-b000-000000000000", "SensorTag Infrared Temperature Service");
        mCharacteristics.put("f000aa01-0451-4000-b000-000000000000", "SensorTag Infrared Temperature Data");
        mCharacteristics.put("f000aa02-0451-4000-b000-000000000000", "SensorTag Infrared Temperature Config");
        mCharacteristics.put("f000aa03-0451-4000-b000-000000000000", "SensorTag Infrared Temperature Period");
        mCharacteristics.put("f000aa11-0451-4000-b000-000000000000", "SensorTag Accelerometer Data");
        mCharacteristics.put("f000aa12-0451-4000-b000-000000000000", "SensorTag Acceleromter Config");
        mCharacteristics.put("f000aa13-0451-4000-b000-000000000000", "SensorTag Accelerometer Period");
        mCharacteristics.put("f000aa21-0451-4000-b000-000000000000", "SensorTag Humidity Data");
        mCharacteristics.put("f000aa22-0451-4000-b000-000000000000", "SensorTag Humidity Config");
        mCharacteristics.put("f000aa23-0451-4000-b000-000000000000", "SensorTag Humidity Period");
        mCharacteristics.put("f000aa31-0451-4000-b000-000000000000", "SensorTag Magnetometer Data");
        mCharacteristics.put("f000aa32-0451-4000-b000-000000000000", "SensorTag Magnetometer Config");
        mCharacteristics.put("f000aa33-0451-4000-b000-000000000000", "SensorTag Magnetometer Period");
        mCharacteristics.put("f000aa41-0451-4000-b000-000000000000", "SensorTag Barometer Data");
        mCharacteristics.put("f000aa42-0451-4000-b000-000000000000", "SensorTag Barometer Config");
        mCharacteristics.put("f000aa43-0451-4000-b000-000000000000", "SensorTag Barometer Calibration");
        mCharacteristics.put("f000aa44-0451-4000-b000-000000000000", "SensorTag Barometer Period");
        mCharacteristics.put("f000aa51-0451-4000-b000-000000000000", "SensorTag Gyroscope Data");
        mCharacteristics.put("f000aa52-0451-4000-b000-000000000000", "SensorTag Gyroscope Config");
        mCharacteristics.put("f000aa53-0451-4000-b000-000000000000", "SensorTag Gyroscope Period");
        mCharacteristics.put("0000ffe1-0000-1000-8000-00805f9b34fb", "SensorTag Keys Data");
        mCharacteristics.put( LbsStrings.Lbs, "LBS demo ");
        mCharacteristics.put( LbsStrings.LbsButton, "LBS demo Button");
        mCharacteristics.put( LbsStrings.LbsLed, "LBS demo LED");
